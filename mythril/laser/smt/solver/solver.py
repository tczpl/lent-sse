...
class BaseSolver(Generic[T]):
    ...
    def assert_and_track(self, *constraints: List[Bool], path_index_str) -> None:
        """Adds the constraints to this solver.
        ...
        for z3_constraint in z3_constraints:
            self.raw.assert_and_track(z3_constraint, path_index_str)
