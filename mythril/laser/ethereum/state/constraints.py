...
class Constraints(list):
    ...
    def is_possible(self, solver_timeout=None, global_path=None, thistx_path=None) -> bool:
        """
        ...
        """
        try:
            get_model_wrapper(self, solver_timeout=solver_timeout, caller = "is_possible", global_path=global_path, thistx_path=thistx_path)
            return True
    ...
    def is_possible_wrapper(self, solver_timeout=None, global_path=None, thistx_path=None) -> int:
        """
        :param solver_timeout: The default timeout uses analysis timeout from args.solver_timeout
        :return: True/False based on the existence of solution of constraints
        """
