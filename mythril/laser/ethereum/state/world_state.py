...
class WorldState:
    ...
    def __init__(
        ...
        self.thistx_path = thistx_path
        self.is_skipped = False
        self.is_final_checked = False
        self.is_final_possible = False
        self.sse_depth = 0
    ...
    def __copy__(self) -> "WorldState":
        ...
        new_world_state.global_path=self.global_path
        new_world_state.thistx_path=self.thistx_path
        new_world_state.is_skipped = self.is_skipped
        new_world_state.is_final_checked = self.is_final_checked
        new_world_state.is_final_possible = self.is_final_possible
        new_world_state.sse_depth = self.sse_depth
