...
def is_unique_jumpdest(jump_dest: BitVec, state: GlobalState) -> bool:
    ...
    try:
        # ···························································································
        if args.use_lent6 == "1":
            if state.world_state.is_final_checked and (not state.world_state.is_final_possible):
                # print("UnsatError")
                raise UnsatError
        # ···························································································
        # print("try continue")
        model = get_model_wrapper(state.world_state.constraints, caller="is_unique_jumpdest1", thistx_path=state.world_state.thistx_path)
    except UnsatError:
        # print("except")
        return True
    ...
    try:
        ...
        model = get_model_wrapper(
            ...
            caller = "is_unique_jumpdest2",
            thistx_path=state.world_state.thistx_path
        )
    except UnsatError:
        return True
    return False
