...
def take_hash(elem):
    constraints = elem.overflowing_state.world_state.constraints + [elem.constraint]
    constraint_hash_input = tuple(
        list(constraints)
    )
    return hash(constraint_hash_input)
...
class IntegerArithmetics(DetectionModule):
    ...
    def _handle_transaction_end(self, state: GlobalState) -> List[Issue]:
        ...
        state_annotation = _get_overflowunderflow_state_annotation(state)
        issues = []
        annotations_list = list(state_annotation.overflowing_state_annotations)
        annotations_list.sort(key=take_hash)
        # print("sorted", len( annotations_list))
        for annotation in annotations_list:
            ...
            if ostate not in self._ostates_satisfiable:              
                try:
                    # ···························································································
                    if args.use_lent6 == "1":
                        if ostate.world_state.is_final_checked and (not ostate.world_state.is_final_possible):
                            raise UnsatError
                    # ···························································································
                    ...
                    solver.get_model_wrapper(constraints, caller="integer",thistx_path=state.world_state.thistx_path)
