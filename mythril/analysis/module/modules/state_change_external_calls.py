    ...
    def _add_external_call(global_state: GlobalState) -> None:
        ...
        try:
            ...
            solver.get_model_wrapper(
                ...
                caller = "state_cahnge_exernal_calls1",
                thistx_path=global_state.world_state.thistx_path
            )

            # Check whether we can also set the callee address
            try:
                constraints += [to == 0xDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEF]
                solver.get_model_wrapper(constraints, caller = "state_cahnge_exernal_calls2", thistx_path=global_state.world_state.thistx_path)
        ...
        if not value.symbolic:
            ...
            try:
                solver.get_model_wrapper(
                    ...
                    caller = "state_cahnge_exernal_calls3",
                    thistx_path=global_state.world_state.thistx_path
                )
                return True
            except UnsatError:
