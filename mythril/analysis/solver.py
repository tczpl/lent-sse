...
from mythril.support.model import get_model_wrapper
...
def pretty_print_model(model):
    ...
    for d in model.decls():
        ...
        try:
            ...
            s = z3.Optimize()
            before_rlimit_count = s.statistics().get_key_value("rlimit count")
            condition = str(z3.simplify(model[d]))
            after_rlimit_count = s.statistics().get_key_value("rlimit count")
            print("pretty_print_model", hash(model[d]),after_rlimit_count-before_rlimit_count,  before_rlimit_count, after_rlimit_count)
...
def get_transaction_sequence(
    ...
    # ···························································································
    if args.use_lent4 == "1" or args.use_lent5 == "1":
        if global_state.world_state.is_skipped:
            ...
            if not global_state.world_state.is_final_possible:
                if args.use_lent5 == "1":
                    args.impossible_paths.add(global_state.world_state.thistx_path)
                raise UnsatError
    ...
    try:
        # ···························································································
        if args.use_lent6 == "1":
            if global_state.world_state.is_final_checked and (not global_state.world_state.is_final_possible):
                raise UnsatError
        # ···························································································
        model = get_model_wrapper(tx_constraints, minimize=minimize, caller="get_transaction_sequence", thistx_path=global_state.world_state.thistx_path)
    except UnsatError:
        raise UnsatError
